      ...
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md">
        <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-4 sm:p-6 shadow-2xl">
          ...
          <div className="text-center mt-6 text-sm sm:text-base">
            <span className="text-gray-400">You haven't any account? </span>
            <Link to="/registration" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-200 hover:underline">
              Create New Account
            </Link>
          </div>
        </div>
